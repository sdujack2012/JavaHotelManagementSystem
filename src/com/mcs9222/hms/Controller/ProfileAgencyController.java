 ...
 * @author kl438
 */
public class ProfileAgencyController extends Controller {
    
    private JTextField tfName;
    private JTable profileTable;
    private ProfileTableModel profileTableModel;
    public ProfileAgencyController(JTextField name, JTable table) {
        tfName = name;
        profileTable = table;
    }
    ...
    private class ProfileTableModel extends AbstractTableModel {
        ...
        public ProfileTableModel() {
            ...
            Query q = em.createNamedQuery("Customer.findByType");
